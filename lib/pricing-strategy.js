...
const PRICING_STRATEGY = {
  ...
  ourStrategy: {
    ...
    philippinePricing: {
      ...
      // Filipino Model Categories (Brand Names)
      modelCategories: {
        'SulatAI': {
          name: '📝 SulatAI',
          tagline: 'Text & Writing Models',
          description: 'Language models for text generation, chat, and writing assistance',
          icon: 'message-square',
          models: ['inno-ai-boyong-4.5', 'inno-ai-boyong-4.0', 'inno-ai-boyong-mini', 'gemini-pro'],
          color: '#00D9FF'
        },
        'SiningAI': {
          name: '🎨 SiningAI',
          ...
          icon: 'image',
          models: ['flux-1.1-pro', 'flux-dev', 'sd-xl'],
          color: '#FF006E'
        },
        'PelikulaAI': {
          name: '🎬 PelikulaAI',
          tagline: 'Video Creation',
          description: 'Generate videos from text or images for marketing and storytelling',
          icon: 'video',
          models: ['wan-2.1-480p', 'wan-2.1-720p'],
          color: '#8338EC'
        },
        'TinigAI': {
          name: '🔊 TinigAI',
          ...
          icon: 'mic',
          models: ['elevenlabs-tts', 'whisper-v3'],
          color: '#FB5607'
        },
        'IsipAI': {
          name: '🤖 IsipAI',
          tagline: 'Reasoning & Agents',
          description: 'Advanced reasoning models for complex tasks and AI agents',
          icon: 'brain',
          models: ['claude-opus-reasoning', 'deepseek-r1'],
          color: '#28a745'
        }
      },
          markupMultiplier: 1.6
    ...
    // Subscription Tiers for Philippine Market (Filipino Names)
    subscriptionTiers: {
      free: {
        name: 'Bayan Starter',
        nameEN: 'Free',
        ...
        features: [
          'Basic AI models (SulatAI)',
          'Community support',
          'Standard latency',
          'Perfect for students & hobbyists'
        ],
        targetMarket: 'Students, hobbyists, testing',
        description: 'Simula ng iyong AI journey - Start your AI journey'
      },
      ...
      starter: {
        ...
        features: [
          'All SulatAI models',
          'Basic SiningAI generation',
          'Email support',
          'API access',
          'Usage analytics'
        ],
        targetMarket: 'Individual developers, freelancers'
      },
      ...
      professional: {
        ...
        features: [
          'All models including premium (SulatAI, SiningAI, PelikulaAI)',
          'Priority processing',
          'TinigAI voice models',
          'Priority support',
          'Custom model aliases',
          'Team collaboration'
        ],
        targetMarket: 'Growing startups, SMEs',
        popular: true
      },
      ...
      enterprise: {
        ...
        features: [
          'Unlimited access to all categories (SulatAI, SiningAI, PelikulaAI, TinigAI, IsipAI)',
          ...
          'SSO integration',
          'Advanced audit logs',
          'IsipAI reasoning models'
        ],
        targetMarket: 'Large enterprises, government, institutions'
      },
      ...
      bayanihan: {
        ...
        pricePHP: 'Custom',
        priceUSD: 'Custom',
        description: 'Special pricing for NGOs, educational institutions, and non-profits',
        limits: {
          requestsPerDay: 'Custom',
          tokensPerMonth: 'Custom',
          concurrentRequests: 'Custom',
          models: ['all']
        },
        features: [
          'All SulatAI models',
          'Educational discounts up to 50%',
          'Dedicated support',
          'Training & workshops',
          'Community contribution program'
        ],
        targetMarket: 'NGOs, schools, universities, non-profits',
        customPricing: true
      }
    },
